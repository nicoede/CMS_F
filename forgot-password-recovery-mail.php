...
function sendmail($username1, $user_email1){
	...
	$emailBody = "<div>" . $username1 . ",<br><br><p>Click <a href = https://cmsnico.herokuapp.com/23err489_q33_reset_password.php?name=" . $username1 . ">here</a><br><br></p>Regards,<br> Admin.</div>";
	...
	$mail->Subject = "CMS System - Password Recovery";
