        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                                    ...
                                    <div class="col-xs-9 text-right">
                                     <div class='huge'>
                                         <?php
                                            ...
                                            $com_counts = mysqli_num_rows($select_all_comments);
                                            echo "<div class='huge'>{$com_counts}</div>";
                                         ?>
                                     </div>
                                      <div>Comments</div>
                                    </div>
                ...
                <?php
                    ...
                    $com_disapp_counts = mysqli_num_rows($select_all_disapproved_comments);
                    
                    $query = "SELECT * FROM users where user_role = 'Subscriber' ";
                    $select_all_subscribers = mysqli_query($connection, $query);
                    $sub_counts = mysqli_num_rows($select_all_subscribers);
                ?>
                      ...
                      function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                          ...
                          <?php
                            ...
                            $element_count = [$post_counts, $post_draft_counts, $com_counts, $com_disapp_counts, $user_counts, $sub_counts, $cat_counts];
